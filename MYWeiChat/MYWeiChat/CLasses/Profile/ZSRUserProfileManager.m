...
static ZSRUserProfileManager *sharedInstance = nil;
@interface ZSRUserProfileManager ()
{
...
@implementation ZSRUserProfileManager
        ...
        if (objects && [objects count] > 0) {
            for (id user in objects) {
                if ([user isKindOfClass:[PFObject class]]) {
                    ZSRUserProfileEntity *entity = [ZSRUserProfileEntity initWithPFObject:user];
...
{
    ZSRUserProfileEntity* entity = [self getUserProfileByUsername:username];
...
{
    if (object) {
        ZSRUserProfileEntity *entity = [ZSRUserProfileEntity initWithPFObject:object];
...
@implementation ZSRUserProfileEntity

+ (instancetype) initWithPFObject:(PFObject *)object
{
    ZSRUserProfileEntity *entity = [[ZSRUserProfileEntity alloc] init];
